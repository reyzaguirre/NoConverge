...
Calculemos ahora las varianzas de los pesos y las tallas. Recordemos que la varianza de los datos de una variable $X$ está dada por:
$$
...
1. Calculamos la matriz de varianzas y covarianzas de $\mathbf{X}$
