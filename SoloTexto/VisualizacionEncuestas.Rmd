...
x <- t(array(rgamma(11000, y, 1), c(11, 1000)))
p <- x / apply(x, 1, sum)
p <- sapply(t(p[, 1:10]), c)

candidato <- rep(c("KF", "CA", "PPK", "AG", "JG", "AT", "VM", "DU", "RR", "NGG"), 1000)
candidato <- factor(candidato, levels = c("KF", "CA", "PPK", "AG", "JG", "AT", "VM", "DU", "RR", "NGG"))
...
x <- t(array(rgamma(16000, y, 1), c(16, 1000)))
p <- x / apply(x, 1, sum)
p <- sapply(t(p[, 1:15]), c)

candidato <- rep(c("KF", "JG", "CA", "PPK", "AG", "AT", "VM", "RR", "DU", "GS", "AB", "VC", "NGG",
                   "AF", "YS"), 1000)
candidato <- factor(candidato, levels = c("KF", "JG", "CA", "PPK", "AG", "AT", "VM", "RR", "DU",
                                          "GS", "AB", "VC", "NGG", "AF", "YS"))
...
```{r fig.height=6, fig.width=10}
set.seed(1)
y <- c(375, 193, 133, 85, 48, 36, 24, 24, 12, 12, 12, 12, 243)
x <- t(array(rgamma(13000, y, 1), c(13, 1000)))
p <- x / apply(x, 1, sum)
p <- sapply(t(p[, 1:12]), c)

candidato <- rep(c("KF", "JG", "PPK", "CA", "AG", "AB", "VM", "AT", "DU", "RR", "NGG", "GS"), 1000)
candidato <- factor(candidato, levels = c("KF", "JG", "PPK", "CA", "AG", "AB", "VM", "AT",
                                          "DU", "RR", "NGG", "GS"))
